...
public class LibreriaController {
	...
	public @ResponseBody List<LibroDto> agregarCarrito(@RequestParam("isbn") int isbn,  @SessionAttribute("carrito") List<LibroDto> carrito) {
		//recogemos el libro cuyo ISBN se recibe como parámetro
		 ...
		 /*Antes de añadir el inicialidazor
		 *
		...
		//Despúes añadiendo elcomentario SessionAtribute nos quitariamos de en medioel http
	...
	//Lo que hice con la anotacion del agregar carrito, se podría hacer aqui;
